...
export const bisren: RaceSetup = {
  ...
  specialAbilitiesOverride: [[ClassNames.THIEF, {'Open Locks': '**Bisren** penalty, deduct 10% from this roll', 'Remove Traps': '**Bisren** penalty, deduct 10% from this roll IF INDOORS, add 20% IF OUTDOORS', 'Pick Pockets': '**Bisren** penalty, deduct 10% from this roll', 'Move Silently': '**Bisren** penalty, deduct 20% from from this roll if IN DOORS/URBAN'}]]
  details: {
    description:
