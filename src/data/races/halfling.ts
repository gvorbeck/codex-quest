...
import InitiativeBonusSvg from "@/assets/svg/InitiativeBonusSvg";
import RangedBonusSvg from "@/assets/svg/RangedBonusSvg";
...
export const halfling: RaceSetup = {
  ...
  icons: [
    [RangedBonusSvg, iconStrings.rangedBonus(1)],
