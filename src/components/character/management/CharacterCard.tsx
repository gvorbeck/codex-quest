...
export function CharacterCard({ character, user, onDelete, isDeleting }: CharacterCardProps) {
  ...
  const classNames = useMemo(() => {
    ...
    const classes = Array.isArray(character.class) ? character.class : [character.class];
