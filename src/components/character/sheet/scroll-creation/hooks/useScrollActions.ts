...
import { formatSpellLevel } from "@/utils";
...
export const useScrollActions = ({
  ...
  const createProject = useCallback(
    (projectData: { spellName: string; spellLevel: number; notes: string }) => {
  ...
  const updateProject = useCallback(
    (projectId: string, updates: Partial<ScrollCreationProject>) => {
