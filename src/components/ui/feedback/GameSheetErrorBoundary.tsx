...
export class GameSheetErrorBoundary extends Component<Props, State> {
  ...
  override componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error("Error in game sheet:", error, errorInfo);
  }
      ...
      return (
        <section className="text-center py-16" role="alert">
          ...
          <p className="text-primary-400 mb-6">
            There was a problem displaying this game sheet. The game 
            data may be corrupted or there's an issue loading the game information.
          </p>
