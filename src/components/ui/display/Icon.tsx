...
const iconPaths: Record<IconName, { viewBox: string; paths: string[]; fill?: boolean; stroke?: boolean }> = {
  ...
  dice: {
    viewBox: '0 0 20 20',
    paths: ['M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.5 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm9.75 3a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-.747-8.498a5.202 5.202 0 0 0-9.006 0A2.5 2.5 0 0 0 2 4.5v9a2.5 2.5 0 0 0 2.5 2.5h9a2.5 2.5 0 0 0 2.5-2.5v-9a2.5 2.5 0 0 0-2.497-2.498z'],
    fill: true
  },
  plus: {
    viewBox: '0 0 24 24',
